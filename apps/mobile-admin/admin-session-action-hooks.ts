...
export const useAdminSessionActions = (params: {
  ...
  setCompanyOrderInPersonSuppliers: (value: any) => void;
  setCompanyOrderInPersonSupplier: (value: string) => void;
  setCompanyOrderInPersonSearch: (value: string) => void;
  setCompanyOrderInPersonDrafts: (value: any) => void;
  setCompanyOrderInPersonLoading: (value: boolean) => void;
  setCompanyOrderInPersonSaving: (value: boolean) => void;
  ...
  const clearAdminSession = useCallback(() => {
    ...
    params.setCompanyOrderMode("orders");
    ...
    params.setCompanyOrderInPersonWeekEndDate("");
    params.setCompanyOrderInPersonSuppliers([]);
    params.setCompanyOrderInPersonSupplier("");
    params.setCompanyOrderInPersonSearch("");
    params.setCompanyOrderInPersonDrafts({});
    params.setCompanyOrderInPersonLoading(false);
    params.setCompanyOrderInPersonSaving(false);
