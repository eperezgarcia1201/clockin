...
import { useCompanyOrderInPersonViewState } from "./company-order-in-person-view-state";
import { useCompanyOrderActions } from "./company-order-action-hooks";
import { useCompanyOrderInPersonActions } from "./company-order-in-person-action-hooks";
...
export default function App() {
  ...
  const {
    ...
    cancelEditUser,
    saveUserEdits,
  } = useUserManagementActions({ fetchJson, newUserName, newUserEmail, newUserPin, scopedLocationId, newUserIsManager, newUserIsOwnerManager, newUserIsAdmin, newUserIsTimeAdmin, newUserIsReports, newUserIsServer, newUserIsKitchenManager, newUserAllowOpenSchedule, setUserStatus, setNewUserName, setNewUserEmail, setNewUserPin, setNewUserIsManager, setNewUserIsOwnerManager, setNewUserIsAdmin, setNewUserIsTimeAdmin, setNewUserIsReports, setNewUserIsServer, setNewUserIsKitchenManager, setNewUserAllowOpenSchedule, editingUserId, editUserForm, setEditUserForm, setEditingUserId, setEditUserStatus, setEditUserLoading, setEditUserSaving, loadEmployees, loadSummary, loadActiveNow, });
  const {
    handleCreateOffice,
  ...
  const {
    visibleItems: companyOrderInPersonItems,
    summaryLabel: companyOrderInPersonSummaryLabel,
    getDraftValue: getCompanyOrderInPersonDraftValue,
    getItemMetaLine: getCompanyOrderInPersonMetaLine,
  } = useCompanyOrderInPersonViewState({
  ...
  const {
    setPurchasedQuantity: setCompanyOrderInPersonPurchasedQuantity,
    setPurchasedWeightLb: setCompanyOrderInPersonPurchasedWeightLb,
    setUnitPrice: setCompanyOrderInPersonUnitPrice,
    setCompanyUnitPrice: setCompanyOrderInPersonCompanyUnitPrice,
    clearInPersonShopping,
    saveInPersonShopping,
    goToPreviousWeek: goToPreviousInPersonShoppingWeek,
    goToNextWeek: goToNextInPersonShoppingWeek,
  } = useCompanyOrderInPersonActions({
    fetchJson,
    officeId: companyOrdersOfficeId,
    weekStartDate: companyOrderInPersonWeekStartDate,
    selectedSupplierName: companyOrderInPersonSupplier,
    suppliers: companyOrderInPersonSuppliers,
    drafts: companyOrderInPersonDrafts,
    setDrafts: setCompanyOrderInPersonDrafts,
    setStatus: setCompanyOrderInPersonStatus,
    setSaving: setCompanyOrderInPersonSaving,
    setWeekStartDate: setCompanyOrderInPersonWeekStartDate,
    setSuppliers: setCompanyOrderInPersonSuppliers,
    setWeekEndDate: setCompanyOrderInPersonWeekEndDate,
    setSelectedSupplierName: setCompanyOrderInPersonSupplier,
  });
  useAdminViewEffects({ loggedIn, screen, loadCompanyOrderCatalog, loadCompanyOrders, loadCompanyOrderInPerson, hasLiquorManagerAccess, loadLiquorControlData, setLiquorCatalog, setLiquorCounts, setLiquorMovements, setLiquorMonthly, setLiquorMonthlyPrevious, setLiquorYearly, setLiquorBottleScans, setLiquorSheetDrafts, setLiquorInvoiceRows, setLiquorInvoiceImageDataUrl, setLiquorInvoiceImageName, setLiquorStatus, companyOrdersOfficeId, companyOrderInPersonWeekStartDate, liquorMonth, liquorTargetCostPct, liquorYear, scopedLocationId, salesExpenseMethod, setSalesExpenseCheckNumber, setSalesExpensePayToCompany, officeGeoTarget, setOfficeGeoLatitude, setOfficeGeoLongitude, setOfficeGeoRadius, setOfficeGeoStatus, liquorInventorySearch, setLiquorInventoryVisibleCount, liquorCatalogSearch, setLiquorCatalogVisibleCount, liquorSheetRows, });
