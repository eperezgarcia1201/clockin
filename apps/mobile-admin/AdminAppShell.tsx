...
export default function App() {
  ...
  const managerScopedLocationId = sessionManagerOfficeId?.trim() || "";
  const canManageMultiLocation =
    !managerScopedLocationId &&
    multiLocationEnabled &&
    permissions.manageMultiLocation;
  const scopedLocationId = managerScopedLocationId || (canManageMultiLocation
