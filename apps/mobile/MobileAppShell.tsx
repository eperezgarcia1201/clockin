...
export default function App() {
  ...
  const resetCompanyOrderVisibleCount = useCallback((count: number) => {
    setCompanyOrderVisibleCount(count);
  ...
  } = useCompanyOrderViewState({ companyOrderCatalog, companyOrderSupplier, companyOrderSearch, companyOrderShowOnlyAdded, companyOrderDrafts, companyOrderVisibleCount, onResetVisibleCount: resetCompanyOrderVisibleCount, });
  ...
  const { loadEmployees, loadTodaySchedule, loadWorkingNow, loadEmployeeWeekSchedule } =
    useViewLoadActions({ tenant, loadingLocations, canUseClockScreen, hasTeamDashboardAccess, selectedOfficeId, fetchJson, t, setEmployees, setDirectoryEmployees, setStatus, setTodaySchedule, setTodayScheduleStatus, setTodayScheduleLoading, setWorkingNowRows, setWorkingNowStatus, setWorkingNowLoading, setEmployeeWeekSchedule, setEmployeeWeekScheduleStatus, setEmployeeWeekScheduleLoading, });
  ...
  useSessionHydrationEffects({ setTenant, setRecentTenants, setTenantInput, setTenantHydrated, setTipsSubmittedByDay, setLanguage, });
  ...
  const { configureTenant, handleSelectSavedTenant, toggleLanguage, handleSelectLocation } =
    useTenantSessionActions({ tenant, recentTenants, tenantInput, resolvedApiBase, language, activeShift, t, setResolvingTenant, setTenantStatus, setTenantOffices, setSelectedOfficeId, setTenantCompanyOrdersEnabled, setTenantLiquorInventoryEnabled, setLocationPickerOpen, setLocationStatus, setTenant, setRecentTenants, setTenantInput, setStatus, setTipsStatus, setResolvedApiBase, setLanguage, setEmployeeName, });
